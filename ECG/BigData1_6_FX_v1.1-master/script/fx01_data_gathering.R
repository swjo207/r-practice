...
fx_krw_usd<-Quandl("BNP/USDKRW", trim_start="2009-07-01", trim_end="2014-06-30")
str(fx_krw_usd)
...
# fx_krw_aud
fx_krw_aud<-Quandl("CURRFX/AUDKRW", trim_start="2009-07-01", trim_end="2014-06-30")
str(fx_krw_aud)
...
# fx_krw_cny
fx_krw_cny<-Quandl("CURRFX/CNYKRW", trim_start="2009-07-01", trim_end="2014-06-30")
str(fx_krw_cny)
...
# fx_krw_gbp
fx_krw_gbp<-Quandl("CURRFX/GBPKRW", trim_start="2009-07-01", trim_end="2014-06-30")
str(fx_krw_gbp)
...
# fx_krw_eur
fx_krw_eur<-Quandl("CURRFX/EURKRW", trim_start="2009-07-01", trim_end="2014-06-30")
str(fx_krw_eur)
...
# yield_ca
yield_ca<-Quandl("YC/CAN", trim_start="2009-07-01", trim_end="2014-06-30")
str(yield_ca)
...
# yield_jp
yield_jp<-Quandl("YC/JPN", trim_start="2009-07-01", trim_end="2014-06-30")
str(yield_jp)
...
# yield_fr
yield_fr<-Quandl("YC/FRA", trim_start="2009-07-01", trim_end="2014-06-30")
str(yield_fr)
...
# yield_nz
yield_nz<-Quandl("YC/NZL", trim_start="2009-07-01", trim_end="2014-06-30")
str(yield_nz)
yield_nz<-yield_nz[,-6]
...
# yield_uk
yield_uk<-Quandl("YC/GBR", trim_start="2009-07-01", trim_end="2014-06-30")
str(yield_uk)
yield_uk<-yield_uk[,-4]
...
# yield_us
yield_us<-Quandl("YC/USA", trim_start="2009-07-01", trim_end="2014-06-30")
str(yield_us)
...
# fx_aud_usd
fx_aud_usd<-Quandl("CURRFX/USDAUD", trim_start="2009-07-01", trim_end="2014-06-30")
str(fx_aud_usd)
...
# fx_cad_usd
fx_cad_usd<-Quandl("CURRFX/USDCAD", trim_start="2009-07-01", trim_end="2014-06-30")
str(fx_cad_usd)
...
# fx_cny_usd
fx_cny_usd<-Quandl("CURRFX/USDCNY", trim_start="2009-07-01", trim_end="2014-06-30")
str(fx_cny_usd)
...
# fx_gbp_usd
fx_gbp_usd<-Quandl("CURRFX/USDGBP", trim_start="2009-07-01", trim_end="2014-06-30")
str(fx_gbp_usd)
...
# fx_jpy_usd
fx_jpy_usd<-Quandl("CURRFX/USDJPY", trim_start="2009-07-01", trim_end="2014-06-30")
str(fx_jpy_usd)
...
# fx_nzd_usd
fx_nzd_usd<-Quandl("CURRFX/USDNZD", trim_start="2009-07-01", trim_end="2014-06-30")
str(fx_nzd_usd)
