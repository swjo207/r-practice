...
summary(train_diff)
par(mfrow=c(2,2))
plot(train_res,ylim=c(-20,20))
plot(train_diff,ylim=c(-20,20))
...
summary(val_diff)
par(mfrow=c(2,2))
plot(val_res,ylim=c(-15,15))
plot(val_diff,ylim=c(-15,15))
hist(val_res,breaks=brks,ylim=c(0,60))
hist(val_diff,breaks=brks,ylim=c(0,60))
par(mfrow=c(1,1))
...
summary(train_diff)
par(mfrow=c(2,2))
plot(train_res_selVar,ylim=c(-20,20))
plot(train_diff,ylim=c(-20,20))
brks<-seq(from=-20,to=20,by=2.5)
hist(train_res_selVar,breaks=brks,ylim=c(0,200))
hist(train_diff,breaks=brks,ylim=c(0,200))
par(mfrow=c(1,1))
...
summary(test_diff)
par(mfrow=c(2,2))
plot(test_res_selVar,ylim=c(-15,15))
plot(test_diff,ylim=c(-15,15))
brks<-seq(from=-20,to=20,by=2.5)
hist(test_res_selVar,breaks=brks,ylim=c(0,80))
hist(test_diff,breaks=brks,ylim=c(0,80))
par(mfrow=c(1,1))
...
summary(val_diff)
par(mfrow=c(2,2))
plot(val_res_selVar,ylim=c(-15,15))
plot(val_diff,ylim=c(-15,15))
